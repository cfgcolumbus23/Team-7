...
export default function Page() {
  ...
  return (
    <div className="">
      ...
      <button className="text-xl text-black rounded-lg border-2 p-2 bg-goodwill-blue text-white w-48 h-16 "onClick={handleNewsClick}>News
        </button>
        <button className="text-xl text-black rounded-lg border-2 p-2 bg-goodwill-blue text-white w-48 h-16" onClick={handleCareerClick}>Careers
        </button>
        <button className="text-xl text-black rounded-lg border-2 p-2 bg-goodwill-blue text-white w-48 h-16 " onClick={handleOppoClick}>Opportunities
        </button>
      </div>
