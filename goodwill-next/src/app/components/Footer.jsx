...
export default function Footer() {
  return (
    <div className="bg-goodwill-blue h-1/2 flex justify-between content-center">
      <div className="w-auto flex gap-5 ml-20 mt-10 flex-col">
        <img
      ...
      <div className="flex flex-col mr-20 justify-between w-auto border-red-800">
        ...
        <div className="flex mb-10 mr-5 ml-auto justify-right gap-5 ">
          <svg
            className="w-8 text-sky-500"
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
